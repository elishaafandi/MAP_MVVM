...
import 'booking_status_rentee_viewmodel.dart';

class BookingStatusRenteeView extends StatelessWidget {
  const BookingStatusRenteeView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewWrapper<BookingStatusRenteeViewModel>(
  ...
  Widget _buildBody(
      BuildContext context, BookingStatusRenteeViewModel viewModel) {
  ...
  Widget _buildBookingCard(
    ...
    BookingStatusRenteeViewModel viewModel,
