...
import 'dart:convert';
import 'renter_feedback_viewmodel.dart';

class RenterFeedbackView extends StatelessWidget {
  
  @override
  Widget build(BuildContext context) {
    return ViewWrapper<RenterFeedbackViewModel>(
                ...
                children: [
                  _buildSection(
                    ...
                    child: _buildFeedbackList(
                      context,
                      viewModel,
                      viewModel.renteeFeedbackStream,
                    ),
                  ),
                  SizedBox(height: 24),
                  _buildSection(
  ...
  Widget _buildFeedbackList(
    ...
    RenterFeedbackViewModel viewModel,
